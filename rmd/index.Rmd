...
* an **account for [workbench](https://workbench.ie-freiburg.mpg.de)**: We will use the Rstudio server at the MPI-IE. If you do not have an account yet, you will need to request an account from core-IT. Please do so well before the course starts. You can use a local installation of R as well. Note that we will be using R 4.3.3 during this course.
