...
> **Task 5:** Please visualize the dispersion in your analysis using the following functions: ```dds <- estimateDispersions(dds)``` and ```plotDispEsts(dds)```

\

```{r, echo=FALSE, out.width = '60%', fig.align="center"}
knitr::include_graphics(c("../explain_dispersion.png"))
```
