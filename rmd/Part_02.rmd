...
plot(x, dpois(x, lambda = mean(x)),  type = "p", col='green')     # Poisson: mean = variance = lambda
lines(x, dnbinom(x, size=10, mu=mean(x)), type = "p", col='blue') # NB:mean < variance; size =  dispersion parameter (shape)
