...
**Task1:** load the data and metadata as done in the previous day.
...
Previously you noticed that the PCA shows a problem with our data. But you might find this kind of issue in datasets without them being tampered.
...
# **2. Quick recap and more explanations** - 40 min
