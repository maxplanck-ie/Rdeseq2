...
> **Poll 2**: What properties can you attribute to RNA-seq data?
...
> **Poll 4**: for small count means, dispersion $\alpha$ is ....? For large mean counts, dispersion $\alpha$ is ....?
...
```{r export_results}
write.table(fdds_res, file="../misc/results.tsv", col.names=T, row.names = T, sep = "\t", quote=F)
```
