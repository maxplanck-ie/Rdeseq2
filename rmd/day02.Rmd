...
ggplot(meta) +
  geom_point(aes(x=seq_depth, y=sizeFactor)) +
  xlab("sequencing depth") +
  ylab("sizefactor")


# colSums(counts(dds_clean)) are not strictly the sequencing depth (after gene filtering), but
# colSums(counts(dds))       may contain more samples (before sample filtering)
sd = dds %>% counts %>% colSums %>% enframe(name="sample", value="seq_depth")
...
There is no extreme outlier for the size factor
