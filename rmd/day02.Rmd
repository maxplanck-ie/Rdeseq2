...
#plotPCA is the DESeq2 function to plot automatically your samples on a PCA. However, the images don't look too nice. So we use it to extract the values needed for plotting and then using them with ggplot to get a better PCA.
...
![](images/day2_factor_order_comparison.png){width=60%}
...
![](images/day2_expression_model.png){width=80%}
...
knitr::include_graphics("images/day2_coverage_depth.png")
```
...
knitr::include_graphics("images/day2_comp_bias.png")
```
...
knitr::include_graphics(c("images/day2_expl_size_factors.png"))
```
...
knitr::include_graphics(c("images/day2_explain_dispersion.png"))
```
...
<center>
```{r, echo=FALSE, out.width = '60%', fig.align='center'}
knitr::include_graphics("images/day2_initial_dispersion.png")
```
...
knitr::include_graphics(c("images/day2_analysis_tools.png"))
```
...
```{r, echo=FALSE, out.width = '80%', fig.align="center"}
knitr::include_graphics("images/day2_shiny_apps.png")
```

  - ClusterProfiler:

```{r, echo=FALSE, out.width = '80%', fig.align="center"}
knitr::include_graphics("images/day2_gene2functions.png")
```
 
  - Ingenuity Pathway Analysis (IPA): tool to help interprete and analyze omics data (e.g. functional enrichment of DEGs)
  
```{r, echo=FALSE, out.width = '60%', fig.align="center"}
knitr::include_graphics("images/day2_ipa_example.jpg")
```
