...
**Poll 1**: How do you get information about the current R-version and loaded packages?
...
**Anynymous Poll 2**: Who has successfully installed the following packages: DESEeq2, tidyverse, pheatmap ?
...
**Poll 3**: How many samples are in the data?
...
**Poll 4**: What is $N$ in this example
