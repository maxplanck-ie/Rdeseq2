...
### Import Metadata
Metadata (=data about data) and typically contains important information on the samples and their origin. 
...
> **Task**  Convert the variables "condition" and "celltype" into factors. 
...
> **Task (optional)**: Extract the 42nd gene in the data matrix and plot it against
