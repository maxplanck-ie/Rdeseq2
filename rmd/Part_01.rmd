...
$(x_1, x_2, x_3)$=("Cond1", "Cond2", "Cond3") $\longrightarrow \left( \begin{array}{ccc} X_1 & X_2 & X_3 \\ 1 & 0 &  0 \\ 1 & 1 & 0 \\ 1 & 0 & 1 \end{array}\right)$ 

A design can be translated into a model matrix
```{r model_matrix}
