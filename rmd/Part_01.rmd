...
```{r import_data}
dfile="/data/manke/processing/RdeseqData/myeloma/myeloma_counts.tsv"      # location of data file
...
```{r import_meta}
mfile <- "/data/manke/processing/RdeseqData/myeloma/myeloma_meta.tsv"               # location of metadata file
