...
> Extract the information in this object to a dataframe
> Remove rows where the baseMean == 0
> Remove rows where the padj column is NA
> sort rows in the dataframe for padj (ascending, to get lowest P-values at the top).
> If you're feeling up to it, these steps can be generalized in a function.
